...
{
    public interface IIndexFileRepository
    {
        /// <summary>
        ...
        /// <param name="indexName"></param>
        /// <returns></returns>
        Task<bool> CloseIndexFileAsync(string indexName = "");
        ...
        /// <param name="indexName"></param>
        /// <returns></returns>
        Task<bool> OpenIndexFileAsync(string indexName = "");
        ...
        /// <param name="indexName"></param>
        /// <returns></returns>
        Task<bool> DeleteIndexFileAsync(string indexName = "");
